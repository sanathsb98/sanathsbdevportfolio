  ...
  return (
    <div className='services-we-offer'>
        <div className='services-offer-titles'>
            <div className='services-offer-title'>MY PROJECTS</div>
         
            <div className='services-offer-description'>Here are some of the projects I have developed and hosted</div>
        </div>
