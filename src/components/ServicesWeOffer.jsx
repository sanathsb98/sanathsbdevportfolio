        ...
        <div className='services-offer-types'>
              ...
              <div className='services-offer-type'>
                  ...
                  <div className='services-content-section'>
                      <div className='services-title'>Event Site (Responsive UI With React)</div>
              ...
              <div className='services-offer-type'>
                  ...
                  <div className='services-content-section'>
                      <div className='services-title'>Redux Cart (Redux JS & React)</div>
                      <div className='services-des'>I developed a responsive redux shopping cart with react and redux which makes the state management easy</div>
